...
/**
 * This class converts degree celcius value from 0 to 100 to it fahrenheit equivalent.
 * 
 * @author satish
 *
 */
public class CelciusToFahrenheit {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < 100; i++) {
			...
			System.out.println(temparatureInCelcius + CELCIUS_UNIT + " = " + temparatureInFahrenheit + FAHRENHEIT_UNIT );
		}
	}
